# Netberg Aurora 720 Platform Driver for SONiC
...
The driver for interacting with Netberg Aurora 720 is contained in the I2C 
...
The IGB module must be loaded first on Netberg Aurora 720 platform.

### I2C i801

The I2C i801 on Netberg Aurora 720 can be found in
`/sys/bus/i2c/devices/i2c-0/`

This is I2C bus for Clock Gen, DIMM channel and digital potentiometers. 

The i801 module must be loaded second on Netberg Aurora 720.

### I2C iSMT

The I2C iSMT module on Netberg Aurora 720 can be found in
`/sys/bus/i2c/devices/i2c-1/`

This is I2C bus for CPLD, HWM, power controller and I2C Switches.

The i801 module must be loaded third on Netberg Aurora 720.

### I2C PCA9548
The PCA9548 module on Netberg Aurora 720 can be found in
...
The hardware components are initialized in the init script on Netberg Aurora 720. 
The following describes manual initialization as well as interaction.
The examples below are just for Netberg Aurora 720 platform.

### Hardware initialization

When the sonic-platform-netberg-aurora-720 package is installed on the Netberg Aurora 720,
