...
PSU_INFO = {
    'PSU1': {
        ...
        'status_path': "/sys/class/hwmon/hwmon2/device/NBA615_POWER/"
    },
    'PSU2': {
        'attr_path': "WILL BE RE-INIT",
        'status_path': "/sys/class/hwmon/hwmon2/device/NBA615_POWER/"
...
FAN_INFO = {
    'FAN1': {
        'isdraw': True,
        'fan_num': 2,
        'attr_path': '/sys/class/hwmon/hwmon2/device/NBA615_FAN/'
    },
    'FAN2': {
        'isdraw': True,
        'fan_num': 2,
...
# 
# 
SFP_EXT_SYSFILE_LIST = ["/sys/class/hwmon/hwmon2/device/NBA615_QSFP/",
                        "/sys/class/hwmon/hwmon2/device/NBA615_SFP/"]
...
class PlatDev():
    def __init__(self):
        ...
        for i in range(2, len(THERMAL_SENSOR_LIST)):
            ...
            if install_info :
                if self.bmc_is_exist():
                    THERMAL_SENSOR_LIST[i]['sysfile_path'] = '/sys/class/hwmon/hwmon2/device/NBA615_THERMAL/'
                else:
        ...
        for psu_name in PSU_LIST:
            ...
            if install_info:
                if self.bmc_is_exist():
                    self.psu_info[psu_name]['attr_path']= '/sys/class/hwmon/hwmon2/device/NBA615_POWER/'
                else:
    ...
    def bmc_is_exist(self):
        bmc_filePath = '/sys/class/hwmon/hwmon2/device/NBA615_SYS/bmc_present'
